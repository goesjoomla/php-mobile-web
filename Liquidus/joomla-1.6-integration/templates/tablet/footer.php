...
/**
 * A footer template for tablet PC in which the primary input method is touching the screen.
 *
...
require dirname(dirname(__FILE__)).DS.'default'.DS.'footer.php';

// Consider a tablet PC as a mobile device that usually does not have a full-featured web browser.
//require dirname(dirname(__FILE__)).DS.'mobile'.DS.'footer.php';
?>